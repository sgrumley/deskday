...
func (s *Service) Out() error {
	...
	daysRecorded := 8 // TODO: mocked res for testing
...
func (d *Days) PrintProgress() {
	...
	// labelConfig holds the text labels used in the display
	...
	labelConfig := map[string]string{
		...
		"Office Days Remaining (month):": fmt.Sprintf("%d", d.GetRemainingWorkDays()),
